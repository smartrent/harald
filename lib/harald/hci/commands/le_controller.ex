defmodule Harald.HCI.Command.LEController do
  ...
  * OGF: `#{inspect(@ogf, base: :hex)}`
  ...
  def list() do
    ...
    |> Enum.filter(&match?(["Harald", "HCI", "Command", "LEController", _mod], Module.split(&1)))
  end
  ...
  defmacro __using__(opts) do
    quote location: :keep, bind_quoted: [opts: opts] do
      ...
      use Harald.HCI.Command, Keyword.put(opts, :ogf, LEC.__ogf__())

      @ocf ocf
      @opcode Harald.HCI.opcode(LEC.__ogf__(), @ocf)
